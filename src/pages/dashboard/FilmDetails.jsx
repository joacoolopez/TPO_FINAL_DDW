...
import { ModalComponent, Trailer } from "../../components";
...
export const FilmDetails = () => {
  ...
  return (
    <div className="container grid grid-cols-1 lg:grid-cols-6 mx-auto mt-10 text-white px-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 md:col-span-4 bg-[#3d3d3d]">
        ...
        <div className="md:col-span-1 p-5 break-words lg:bg-[#454545]">
          <div className="mb-4">
